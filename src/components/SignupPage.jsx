...
export default function SignupPage({ onSwitchToLogin }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-4 py-6 overflow-auto">
      <div className="w-full max-w-xl my-4">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-white">Valora AI</h1>
          <p className="text-slate-400 mt-2 text-lg">Your Smart Real Estate Assistant</p>
        </div>

        {/* Signup Card */}
        <div className="bg-slate-800/50 backdrop-blur-xl rounded-3xl border border-slate-700/50 p-6 md:p-8 shadow-2xl">
