...
Report generated by Valora AI - City Intelligence Platform
        ...
        {activeTab === 'explain' && (
          <ExplainabilityPanel 
            analysis={liveAnalysis || agentData?.explainability || {
              confidence: agentData?.dashboard?.confidence || 75,
              keyDrivers: agentData?.dashboard?.keyDrivers || [],
              reasoning_chain: agentData?.reasoningTrace?.steps || [],
              causal_analysis: agentData?.causalAnalysis,
              risk_profile: agentData?.riskProfile,
              risk_warnings: agentData?.riskWarnings || [],
